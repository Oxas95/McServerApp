...
import main.frames.FileChooser;
import main.frames.IFrame;
import main.frames.frameMenu.edit.Edit;
import main.frames.frameMenu.help.Help;
...
public class FrameMenu extends IFrame {
	...
	protected void addContentMenu() {
		...
		menus.add(new main.frames.frameMenu.file.File());
		menus.add(new Edit());
		menus.add(new Help());
